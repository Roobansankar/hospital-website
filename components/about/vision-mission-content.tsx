...
const VisionMissionContent = () => {
  const values = [
    ...
    },
    {
      ...
      title: "Excellence",
      description:
        "We strive for the highest standards in medical care, service quality, and professional competence.",
    },
    {
      icon: <Users className="h-12 w-12 text-blue-600" />,
      title: "Teamwork",
      description:
        "We collaborate effectively across disciplines to provide comprehensive and coordinated care.",
    },
    {
      icon: <Shield className="h-12 w-12 text-blue-600" />,
      title: "Integrity",
      description:
        "We uphold ethical principles, transparency, and accountability in all our actions and decisions.",
    },
    {
        ...
        <div className="mb-20 grid grid-cols-1 gap-16 md:grid-cols-2">
          ...
          >
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300">
              To be the leading healthcare institution recognized for excellence
              in patient care, medical innovation, and community wellness,
              setting the standard for compassionate and comprehensive
              healthcare services.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300">
              ...
              compassionate care, medical expertise, and continuous innovation,
          ...
          <div className="mx-auto max-w-3xl space-y-6 text-center">
            ...
            >
              <li className="flex items-start">
                ...
                <span>
                  Providing patient-centered care that respects individual
              ...
              <li className="flex items-start">
                <span className="mr-2 text-blue-600">•</span>
                <span>
                  Ensuring the highest standards of quality and safety in all
                  our services
                </span>
              </li>
              <li className="flex items-start">
                <span className="mr-2 text-blue-600">•</span>
                <span>
                  Embracing innovation and continuous improvement in healthcare
                  delivery
                </span>
              </li>
              <li className="flex items-start">
                <span className="mr-2 text-blue-600">•</span>
                <span>
                  Fostering a collaborative environment that values teamwork and
              ...
              <li className="flex items-start">
                <span className="mr-2 text-blue-600">•</span>
                <span>
                  Contributing to community health through education,
              ...
              <li className="flex items-start">
                <span className="mr-2 text-blue-600">•</span>
                <span>
                  Maintaining transparency, integrity, and ethical standards in
                  all our operations
                </span>
              </li>
            </ul>
