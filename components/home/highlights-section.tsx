  ...
  const highlights = [
    {
      ...
      description: "Round-the-clock emergency services with rapid response teams ready to provide immediate care.",
      delay: "0",
    },
    {
      icon: <UserCheck className="h-12 w-12 text-blue-600" />,
      title: "Experienced Doctors",
      description: "Team of highly qualified and experienced medical professionals across various specializations.",
      delay: "100",
    },
    {
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          {highlights.map((highlight, index) => (
            ...
            >
              ...
              <h3 className="mb-3 text-xl font-semibold text-gray-900 dark:text-white">{highlight.title}</h3>
