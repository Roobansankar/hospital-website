      ...
      <div className="container mx-auto px-4">
        <div className="mb-16 grid grid-cols-1 gap-12 md:grid-cols-2">
          <div data-animation="fade-right">
            <h2 className="mb-6 text-3xl font-bold text-gray-900 dark:text-white">Department Overview</h2>
            <div className="mb-6 h-1 w-24 bg-blue-600"></div>
            <p className="mb-6 text-lg text-gray-700 dark:text-gray-300">{department.overview}</p>
            <Button asChild>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            {department.services.map((service, index) => (
              ...
              >
                <h3 className="mb-4 text-xl font-semibold text-gray-900 dark:text-white">{service.name}</h3>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {department.team.map((doctor, index) => (
              ...
              >
                ...
                <h3 className="mb-1 text-lg font-bold text-gray-900 dark:text-white">{doctor.name}</h3>
                <p className="mb-2 text-blue-600 dark:text-blue-400">{doctor.position}</p>
                <p className="text-sm text-gray-600 dark:text-gray-400">Specialization: {doctor.specialization}</p>
              </div>
            ))}
          </div>
        </div>
