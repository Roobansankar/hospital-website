      ...
      <div className="mb-12 space-y-8 text-left">
        ...
        >
          ...
          <div>
            ...
            <p className="text-gray-700 dark:text-gray-300">
              <span className="font-medium">Emergency Department:</span> 24/7
              <br />
              <span className="font-medium">Outpatient Departments:</span>{" "}
              Mon–Fri, 8:00 AM – 8:00 PM
              <br />
              <span className="font-medium">Weekend OPD:</span> Saturday, 9:00
              AM – 5:00 PM
              <br />
        ...
        >
          ...
          <div>
            ...
            <p className="text-gray-700 dark:text-gray-300">
              You can call, use our online system, or visit in person to book
              appointments.
            </p>
          </div>
        </div>
